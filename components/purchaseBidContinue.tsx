...
const PurchaseBidContinueComponent: React.FC<PurchaseBidComponentProps> = ({
  params,
  onSubmit,
  setPurchaseBidData,
}) => {
          ...
          <button
            ...
            className={
              desiredPrice && selectedDuration !== 0
                ? 'bg-red-500 text-white py-4 rounded-md font-bold w-full'
...
export default PurchaseBidContinueComponent;
